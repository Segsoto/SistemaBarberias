    ...
    -- VERSIÓN: 2.1 (Corregido error de columna ambigua)
    ...
    -- Eliminar todas las políticas RLS existentes de forma segura
    DO $$
    DECLARE
        r RECORD;
        policy_record RECORD;
    BEGIN
        -- Eliminar políticas específicas conocidas
        FOR r IN (SELECT schemaname, tablename FROM pg_tables WHERE schemaname = 'public') LOOP
            -- Eliminar todas las políticas de cada tabla
            FOR policy_record IN (
                ...
                BEGIN
                    EXECUTE format('DROP POLICY IF EXISTS %I ON %I.%I CASCADE', 
                                policy_record.policyname, r.schemaname, r.tablename);
    ...
    DROP FUNCTION IF EXISTS calculate_appointment_end_time() CASCADE;
    ...
    DROP TRIGGER IF EXISTS update_barbershops_updated_at ON barbershops CASCADE;
    DROP TRIGGER IF EXISTS update_barbers_updated_at ON barbers CASCADE;
    ...
    -- Eliminar todas las tablas en orden correcto (respetando dependencias)
    -- Solo eliminar tablas que realmente existen o pueden existir
    DROP TABLE IF EXISTS reports CASCADE;
    DROP TABLE IF EXISTS appointments CASCADE;
    DROP TABLE IF EXISTS clients CASCADE;
    DROP TABLE IF EXISTS barbers CASCADE;
    DROP TABLE IF EXISTS barbershops CASCADE;
    -- Estas son tablas del sistema anterior que pueden o no existir
    ...
    -- NO eliminar extensiones básicas como uuid-ossp y pgcrypto
    -- ya que son necesarias para el funcionamiento del sistema
    ...
    -- ===================================================================
    -- 2. EXTENSIONES NECESARIAS (CREAR PRIMERO)
    -- ===================================================================

    -- Crear extensiones necesarias ANTES de crear cualquier estructura
    ...
    DO $$
    BEGIN
        RAISE NOTICE '✅ Base de datos limpiada y extensiones instaladas. Procediendo con la creación de estructuras...';
    END $$;
    ...
    DO $$
    BEGIN
        RAISE NOTICE '🔄 Creando tipos enumerados...';
    END $$;
    ...
    -- Confirmación de tipos creados
    DO $$
    BEGIN
        RAISE NOTICE '✅ Tipos enumerados creados exitosamente';
    END $$;
    ...
    DO $$
    BEGIN
        RAISE NOTICE '🔄 Creando tablas principales del sistema...';
    END $$;
    ...
    DO $$
    BEGIN
        RAISE NOTICE '✅ Todas las tablas principales han sido creadas exitosamente';
    END $$;
    ...
    DO $$
    BEGIN
        RAISE NOTICE '✅ Todos los índices han sido creados exitosamente';
    END $$;
