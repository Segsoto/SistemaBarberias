-- ===================================================================
-- SCRIPT PRINCIPAL DE CREACIÓN - SISTEMA DE BARBERÍA
-- ===================================================================
-- EJECUTA ESTE SCRIPT DESPUÉS del clean-database.sql
-- VERSIÓN: 2.2 (Simplificada y sin limpieza)
...
DO $$
BEGIN
    RAISE NOTICE '✅ Extensiones verificadas/instaladas';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE '🔄 Creando funciones y triggers...';
END $$;
...
-- ===================================================================
-- 7. INSERTAR DATOS DE PRUEBA - BARBERÍA DEMO
-- ===================================================================
...
SELECT 'TOTAL CLIENTES:' as info, COUNT(*) as cantidad FROM clients;
SELECT 'TOTAL CITAS:' as info, COUNT(*) as cantidad FROM appointments;
...
SELECT '4. ¡El sistema está listo para usar!' as paso_4;